...
??? abstract "Tabela 2"
    ...
    **Tabela 2** - Artefatos da entrega 2
    ...
    | [Análise Hierárquica de Tarefas](../analise-de-requisitos/analise-de-tarefas/analiseHierarquicaTarefa.md) | Método de análise de tarefas da aplicação.                  | [João Artur](https://github.com/joao-artl)|[Diego Sousa](https://github.com/DiegoSousaLeite)|
