...
| 3   | O planejamento apresenta os participantes selecionados?<a id="anchor_10" href="#REF10">^10^</a>                                       |     NÃO     |      No artefato não consta os participantes      |
| 4   | O perfil dos participantes selecionados está alinhado com o perfil de usuário?<a id="anchor_10" href="#REF10">^10^</a>         |     NÃO     |      -      |
...
| 9  | O planejamento contempla um plano para o reprojeto do sistema, se necessário?<a id="anchor_10" href="#REF10">^10^</a>            |     INCOMPLETO     |      Não existe necessariamente um plano mas apenas sugestões para uma versão futura    |
