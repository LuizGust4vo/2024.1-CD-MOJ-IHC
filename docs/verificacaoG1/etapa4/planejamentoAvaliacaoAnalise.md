...
| 5  | O documento lista os participantes da avaliação? <a id="anchor_6" href="#REF6">^6^</a> | Sim | - |
| 6  | O documento justifica o número de participantes escolhidos? <a id="anchor_6" href="#REF6">^6^</a> | Sim | - |
| 7  | O documento define o perfil dos participantes de acordo com o perfil de usuário? <a id="anchor_6" href="#REF6">^6^</a> | Sim | - |
...
| 9  | O documento apresenta uma estimativa dos custos? <a id="anchor_6" href="#REF6">^6^</a> | Não | - |
| 10 | O documento detalha os recursos humanos necessários? <a id="anchor_6" href="#REF6">^6^</a> | Incompleto | - |
| 11 | O documento aborda como as questões éticas serão tratadas? <a id="anchor_6" href="#REF6">^6^</a> | Incompleto | Falta o termo de consentimento |
| 12 | O documento descreve as tarefas a serem realizadas durante a avaliação? <a id="anchor_6" href="#REF6">^6^</a> | Sim | Falta um passo a passo especificando cada tarefa |
| 13 | O documento inclui uma seção de teste piloto com definição, participantes, local, data e horário da realização do teste piloto? <a id="anchor_7" href="#REF7">^7^</a> | Incompleto | Falta  informações sobre o teste piloto |
| 14 | O planejamento prevê a gravação do teste piloto? <a id="anchor_7" href="#REF7">^7^</a> | Incompleto | Falta  informações sobre o teste piloto |
| 15 | O documento inclui uma seção sobre a interpretação e apresentação dos dados? <a id="anchor_8" href="#REF8">^8^</a> | Incompleto | Possui o tópico sobre isso, porém, está muito superficial |
| 16 | O planejamento segue o framework DECIDE? <a id="anchor_9" href="#REF9">^9^</a> | Sim | - |
| 17 | O planejamento descreve como serão documentados e tratados os dados obtidos durante a avaliação? (Inclui grau de confiabilidade das respostas, contexto em que foram produzidas e conformidade com o perfil de usuário traçado.) <a id="anchor_9" href="#REF9">^9^</a> | Incompleto | Possui o tópico sobre isso, porém, está muito superficial |
